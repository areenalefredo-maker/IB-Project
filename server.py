...
def _apply_qp(doc):
    ...
    # ── COSMETIC: linguistic changes only, no scientific impact ──────────
    # "antacid tablet" → "indigestion tablet"
    p=doc[1]
    _sp(p,"in a 1.62"+TS+"g","antacid","indigestion")
    _sp(p,"nitric acid, which was","antacid","indigestion")
    p=doc[2]
    _sp(p,"in the antacid","antacid","indigestion")
    _sp(p,"aluminium hydroxide in the","antacid","indigestion")
    # "lumps of" → "pieces of" in Q2
    p=doc[3]
    _sp(p,"pieces of magne","pieces of","lumps of")  # reset if already changed
    _sp(p,"sulfuric acid is added to lumps of magne",
        "lumps of","pieces of")
    # "container" → "vessel" in Q6
    p=doc[13]
    _sp(p,"is placed in a 1.00"+TS+"dm³",
        "is placed in a 1.00 dm³","is placed in a 1.00 dm³ vessel")
